...
let Headss = document.getElementById('Heads');

if (hour >= 4 && hour < 12) {
  Headss.innerText = "Good Morning User";
} else if (hour >= 12 && hour < 17) {
  Headss.innerText = "Good Afternoon User";
} else {
  Headss.innerText = "Good Evening User";
}
